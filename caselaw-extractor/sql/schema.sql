...
CREATE TABLE IF NOT EXISTS cases (
    ...
    -- Stable CURIE derived from the official citation triplet plus RHS name.
    -- Populated by the importer; analysis tables FK on this rather than id
    -- so they survive a full reimport of the corpus.
    curie TEXT,
...
CREATE TABLE IF NOT EXISTS opinions (
    ...
    -- Zero-based position of this opinion within CAP's `opinions` array
    -- for its parent case. Stability anchor for the CURIE below — do not
    -- reassign without regenerating curies and re-pointing analysis rows.
    opinion_index INTEGER,

    -- Stable CURIE: <caseCurie>#<index>-<type>[-<author-slug>].
    -- Generated by generateOpinionCurie() in
...
-- CURIE + positional uniqueness (mirrors migration 093)
